...
try{
  ...
  const made=await call("/api/admin/servers",{method:"POST",cookie:adminCookie,...jsonBody({name:`Bot Server ${stamp}`,description:"Otomatik yetki testi",cap:110,server_type:"EU/CH",operational_status:"offline",status_note:"Test",is_active:true})});created.server=made.data.id||null;
